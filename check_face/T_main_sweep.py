...
T_BEFORE_GROW = 1
T_PS_GROW = 2
# T_MAINTAIN will be swept
ERROR_RATE = 0.001

if __name__ == "__main__":
    tasks = []
    
    # 遍历参数 T_MAINTAIN (从 3 到 10)
    for t_maintain in range(3, 5):
        ...
        tasks.append(
            sinter.Task(
                ...
                json_metadata={'T_MAINTAIN': t_maintain, 'p': ERROR_RATE}
            )
        )
    ...
    # 保存结果到 CSV
    output_file = "sinter_results_sweep_maintain.csv"
